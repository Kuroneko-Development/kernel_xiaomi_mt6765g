...
#if 0
	no_printk("E  Is_Read_LRC_Data=%d", Is_Read_LRC_Data);

	for (i = 0; i < 140; i++)
		no_printk("dump LRC[i]=%d", i, imx499_LRC_data[i]);
#endif
	tosend = 0;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	no_printk("[IMX499MIPI]enter IMX499MIPIGain2Reg function\n");
	...
	no_printk("exit IMX499MIPIGain2Reg function\n");
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		no_printk("Please use EEPROM function\n");
		break;
