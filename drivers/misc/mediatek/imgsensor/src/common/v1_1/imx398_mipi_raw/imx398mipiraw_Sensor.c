...
static kal_uint32 imx398_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	...
	no_printk("[%s] ABS_GAIN_GR:%d, grgain_32:%d\n", __func__,
		pSetSensorAWB->ABS_GAIN_GR, grgain_32);

	no_printk("[%s] ABS_GAIN_R:%d, rgain_32:%d\n", __func__,
		pSetSensorAWB->ABS_GAIN_R, rgain_32);

	no_printk("[%s] ABS_GAIN_B:%d, bgain_32:%d\n", __func__,
		pSetSensorAWB->ABS_GAIN_B, bgain_32);

	no_printk("[%s] ABS_GAIN_GB:%d, gbgain_32:%d\n", __func__,
