...
#define SEG3_GPU_DVFS_FREQ3			(490000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ4			(465000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ5			(442500)	/* KHz */
#define SEG3_GPU_DVFS_FREQ6			(420000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ7			(380000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ8			(340000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(50000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(46000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(44500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT3			(40000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT4			(36200)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT5			(35700)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT6			(34200)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT7			(30000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT8			(27000)		/* mV x 100 */
